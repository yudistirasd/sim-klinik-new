          ...
          <div class="col-md-6 col-sm-12">
            <div class="row mb-3">
              <div class="col-md">
                ...
                <input type="text" class="form-control" disabled value="{{ $pasien->norm }}" placeholder="Otomatis oleh sistem">
              </div>
              <div class="col-md">
    ...
    document.addEventListener('alpine:init', () => {
      Alpine.data('form', () => ({
        ...
        handleSubmit() {
          ...
          $.ajax({
            url: route('api.registrasi.pasien.update', pasien.id),
            method: 'POST',
            data: {
              ...this.form,
              '_method': 'PUT'
        ...
        initSelect2() {
          ...
          const optionProvinsi = new Option(defaultProvinsi.text, defaultProvinsi.id, true, true);
          const optionKabupaten = new Option(pasien.kabupaten.name, pasien.kabupaten.id, true, true);
          const optionKecamatan = new Option(pasien.kecamatan.name, pasien.kecamatan.id, true, true);
          const optionKelurahan = new Option(pasien.kelurahan.name, pasien.kelurahan.id, true, true);

          selectProvinsi.append(optionProvinsi).trigger('change');
          selectKabupaten.append(optionKabupaten).trigger('change');
          selectKecamatan.append(optionKecamatan).trigger('change');
          selectKelurahan.append(optionKelurahan).trigger('change');
        },
