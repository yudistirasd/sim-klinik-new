...
class ExFPDFNotaKosong extends FPDF
{

    public $nota;
    public $fileName;

    public function setNota($nota, $fileName)
    {
        $this->nota = $nota;
    ...
    {
        $profile = Profile::find($this->nota->profile_id);

        $this->SetTitle('FAKTUR PENJUALAN ' . $this->nota->nomor);
        $this->Image(url('img/logo.png'), 10, 8, 37, 24);
        $this->SetFont('Arial', 'B', 14);
        $this->SetY(10);
        $this->SetX(50);
        $this->MultiCell(75, 5, $profile->name, 0, 'L');
        $this->SetFont('Arial', 'B', 9);
        $this->SetY(15);
        $this->SetX(50);
        $this->MultiCell(80, 5, $profile->alamat_faktur_line_1, 0, 'L');

        $this->SetFont('Arial', 'B', 8);
        $this->SetY(20);
        $this->SetX(50);
        $this->MultiCell(80, 5, $profile->alamat_faktur_line_2, 0, 'L');
        $this->SetY(25);
        $this->SetX(50);
        $this->MultiCell(68, 5, "Telp. $profile->telepone", 0, 'L');

        // kanan
        $this->SetFont('Arial', 'B', 8);
        $this->SetY(10);
        $this->SetX(135);
        $this->MultiCell(40, 5, "No / Tgl Faktur", 0, 'L');
        $this->SetFont('Arial', '', 8);
        $this->SetY(10);
        $this->SetX(156);
        $this->MultiCell(70, 5, ": {$this->nota->nomor} / {$this->nota->tanggal}", 0, 'L');

        $this->SetFont('Arial', 'B', 8);
        $this->SetY(15);
        $this->SetX(135);
        $this->MultiCell(20, 5, "Nama", 0, 'L');
        $this->SetFont('Arial', '', 8);
        $this->SetY(15);
        $this->SetX(156);
        $this->MultiCell(70, 5, ": Tn/Ny. {$this->nota->nama}", 0, 'L');

        $this->SetFont('Arial', 'B', 8);
        $this->SetY(20);
        $this->SetX(135);
        $this->MultiCell(20, 5, "No. HP", 0, 'L');
        $this->SetFont('Arial', '', 8);
        $this->SetY(20);
        $this->SetX(156);
        $this->MultiCell(70, 5, ": {$this->nota->telp}", 0, 'L');

        $this->SetFont('Arial', 'B', 8);
        $this->SetY(25);
        $this->SetX(135);
        $this->MultiCell(20, 5, "Alamat", 0, 'L');
        $this->SetFont('Arial', '', 8);
        $this->SetY(25);
        $this->SetX(156);
        $this->MultiCell(57, 4, ": {$this->nota->alamat}", 0, 'L');
        ...
        $this->SetY(36);
        $this->SetX(8);
        $this->MultiCell(190, 5, $this->fileName, 0, 'C');
    }
